* Create new Font in Unity:
1. Window / TextMessPro / Font Asset Creator
2. Drag Font into "Source Font File".
3. Generate Font Atlas.
4. Save.
5. Done.

* Create new Font Format in Unity:
...
- Or Just copy TextMessPro Folder in Assets to another Project.