...
public class SampleCustomEditor : MonoBehaviour
{
...
[CustomEditor(typeof(SampleCustomEditor))]
public class SampleCustomEditorEditor : Editor
{
    private SampleCustomEditor m_target;
    ...
    {
        m_target = (target as SampleCustomEditor);
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (m_target.m_VaribleA == SampleCustomEditor.Option.Option1)
        {
    ...
    {
        SampleCustomEditor m_Temp = (target as SampleCustomEditor);
